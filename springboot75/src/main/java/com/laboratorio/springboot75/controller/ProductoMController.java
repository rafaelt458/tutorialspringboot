package com.laboratorio.springboot75.controller;
...
@RestController
@RequestMapping("/api/productos/mysql")
public class ProductoMController {
    private final ProductoService productoService;

    public ProductoMController(@Qualifier("productoMServiceImpl") ProductoService productoService) {
