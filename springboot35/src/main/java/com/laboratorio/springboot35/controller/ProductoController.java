...
import com.laboratorio.springboot35.service.ProductoService;
...
public class ProductoController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ProductoResponse> update(@PathVariable Integer id, @RequestBody ProductoRequest request) {
