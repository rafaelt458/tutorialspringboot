...
import com.laboratorio.springboot34.model.validation.Experiencia;
import com.laboratorio.springboot34.model.validation.MayorDeEdad;
...
public class PersonaRequest {
    ...
    @Pattern(regexp = "^(0[1-9]|[12]\\d|3[01])/(0[1-9]|1[0-2])/\\d{4}$", message = "Formato de fecha incorrecto. Debe ser dd/mm/aaaa")
    // @MayorDeEdad
