package com.laboratorio.springboot54.security;

import com.laboratorio.springboot54.exception.CustomAccessDeniedHandler;
import com.laboratorio.springboot54.exception.CustomAuthenticationEntryPoint;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity,
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(http -> {
                    ...
                    http.requestMatchers("/api/usuarios/signup").permitAll();
                    http.requestMatchers("/api/usuarios/validate/**").permitAll();
                    // Endpoints privados
