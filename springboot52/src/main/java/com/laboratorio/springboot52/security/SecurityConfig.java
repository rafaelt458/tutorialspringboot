package com.laboratorio.springboot52.security;

import com.laboratorio.springboot52.exception.CustomAccessDeniedHandler;
import com.laboratorio.springboot52.exception.CustomAuthenticationEntryPoint;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity,
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(http -> {
                    ...
                    http.requestMatchers("/api/usuarios/email").permitAll();
                    // Endpoints privados
