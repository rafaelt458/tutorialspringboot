...
@ConditionalOnProperty(name = "implementacion.producto.service", havingValue = "implementacion_2")
public class ProductoServiceImpl2 implements ProductoService {
    ...
    public String delete(Integer id) {
        ...
        return "Impl2: Se ha eliminado el producto " + productoAEliminar.getNombre();
    }
}