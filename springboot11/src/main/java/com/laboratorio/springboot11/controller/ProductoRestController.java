package com.laboratorio.springboot11.controller;

import com.laboratorio.springboot11.model.Producto;
import com.laboratorio.springboot11.service.ProductoService;
import com.laboratorio.springboot11.util.exception.InvalidDataException;
...
public class ProductoRestController {
    ...
    public ResponseEntity<?> findById(@PathVariable  Integer id) {
        ...
        if (producto.isEmpty()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("No se ha encontrado el producto con id: " + id);
        }
