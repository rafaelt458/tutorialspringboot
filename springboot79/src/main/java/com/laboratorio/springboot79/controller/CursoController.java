package com.laboratorio.springboot79.controller;
...
public class CursoController {
    ...
    @PatchMapping("/{codigo}/instructor/{instructorName}")
    public ResponseEntity<Boolean> addInstructor(@PathVariable String codigo,
                                                 @PathVariable String instructorName) {
        Boolean result = this.cursoService.addInstructor(codigo, instructorName);
