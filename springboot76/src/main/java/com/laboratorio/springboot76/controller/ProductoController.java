...
import com.laboratorio.springboot76.exception.ParameterException;
import com.laboratorio.springboot76.exception.ResourceNotFoundException;
import com.laboratorio.springboot76.service.ProductoService;
...
public class ProductoController {
    ...
    public ResponseEntity<ProductoResponse> findCategoria(
        ...
        if (((id == null) && (nombre == null)) || ((id != null) && (nombre != null))) {
            log.info("Se ha producido un problema al obtener el producto");
    ...
    public ResponseEntity<String> delete(@PathVariable Integer id) {
        ...
        return ResponseEntity.ok("No existe un producto con id: " + id);
    }
}